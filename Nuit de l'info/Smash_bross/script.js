...
function attaque(){
    ...
    projectileDiv.src = 'Mario_Fireball.png';
    projectileDiv.className = 'projectile';
    projectileDiv.style.lef = (player.x + player_default.largeur) + 'px';
    projectileDiv.style.top = player.y + 'px';
    projectileDiv.style.width = 150 + 'px';
    projectileDiv.style.height = 146 + 'px';
...
//         enemy.x += enemySpeed;
//     } 
//     if (enemy.x > player.x && enemy.x < 1136){
//             enemy.x -= enemySpeed;
//     }
//     console.log('enemy.x : ' + enemy.x);
